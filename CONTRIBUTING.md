# Contributing to NoBreakThisWeek

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to NoBreakThisWeek. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
When we make a significant decision in how we maintain the project and what we can or cannot support, we will document it in the [NoBreakThisWeek Project Documentation](https://tungsten-icebreaker-993.notion.site/NoBreakThisWeek-f539df7cee6a4caea135316a298ec63e). If you have a question around how we do things, check to see if it is documented there.

## How Can I Contribute?

### Reporting Bugs

This section guides you through submitting a bug report for NoBreakThisWeek. Following these guidelines helps maintainers and the community understand your report :pencil:, reproduce the behavior :computer: :computer:, and find related reports :mag_right:.
...
Enhancement suggestions are tracked as [GitHub issues](https://guides.github.com/features/issues/). After, create an issue on that repository and provide the following information:
...
- Maintain NoBreakThisWeek's quality
- Fix problems that are important to users
- Engage the community in working toward the best possible Atom
- Enable a sustainable system for NoBreakThisWeek's maintainers to review contributions
